...
meta:
	ADDON_NAME = ofxOpenCvSurfaceMatching
	ADDON_DESCRIPTION = openFrameworks addon that performs surface matching using openCv's contrib surface matching module
	ADDON_AUTHOR = @roymacdonald
	ADDON_TAGS = "addon" "opencv" "opencv-contrib" "surface matching"
	ADDON_URL = http://github.com/roymacdonald/ofxOpenCvSurfaceMatching

common:
	# dependencies with other addons, a list of them separated by spaces 
	# or use += in several lines
	ADDON_DEPENDENCIES = ofxTbb ofxOpenCvContrib
